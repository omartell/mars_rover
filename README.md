...
1. Left : the robot turns left 90 degrees and remains on the current grid point. 
2. Right : the robot turns right 90 degrees and remains on the current grid point. 
3. Forward : the robot moves forward one grid point in the direction of the current orientation and maintains the same orientation.
